    ...
    <div class="sidebar">
        ...
        <nav class="mt-5">
            <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ route('applicant.training_profile') }}" class="nav-link link training-link">
                        <i class="far fa-chalkboard-teacher nav-icon"></i>
                        <p>Other Trainings</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('applicant.membership_profile') }}" class="nav-link link membership-link">
                        <i class="far fa-file-certificate nav-icon"></i>
                        <p style="z-index: auto;">Professional Membership</p>
                    </a>
                </li>
                <li class="nav-item">
